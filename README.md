...
우리는 Bytom 블록체인 프로토콜이 가상세계와 현실세계를 연결시켜 인간이 상상할 수 있는   
  ...
  > 3가지 특징이, V-Story가 추구하는 Social Life Service  플랫폼으로 확장에   
...
라는 철학으로 기획하고 개발한 플랫폼으로써 사용지들이 스스로 생산한 컨텐츠에 가치를 부여하고 
상호 거래하는 상업적 플랫폼입니다. 
...
블록체인 기반 위에서 신뢰도 높은 양질의 콘텐츠 생산과 소비 생태계를 구현 합니다.  
...
자신의 기분과 감정을 비쥬얼하게 표현 하고, 다양한 Visual 상호작용 으로 색다른 소통 경험을 제공합니다.

PC,모바일,테블릿 등의 다양한 디바이스에서 즐길 수 있고,
아바타,코스튬 등을 카메라를 이용하여 손쉽게 제작 할 수 있으며,
간편한 터치만으로 콘텐츠를 공유/판매를 할 수 있는, 최적화 된 사용자 인터페이스를 제공합니다.
