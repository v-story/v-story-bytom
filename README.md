...
> 사용자가 생산하고 공유한 콘텐츠로 인해 활성화되는 과정에서 일어나는 수익을 사용자들에게 돌려주어 모두가 수익을 얻을 수 있게 하자.

라는 신념으로 기획하고 개발해온 서비스 플랫폼으로써 현재 알파버전이 구동되고 있고,  
사용지들이 스스로 생산한 컨텐츠에 가치를 부여하고 서로 거래하며 건전한 생태계를 유지시킬수 있기에  
상용화는 물론 상업적 가치도 충분다하고 생각합니다.
...
HTML5로 개발되어 사용자 접근성이 뛰어나며  
사용자의 목적에 맞게 커스텀 할수 있는 Visual 공간을 제공하고  
블록체인의 신뢰기반 위에 질 좋은 콘텐트와 생태계를 유지할수 있는 특징을 가지고 있습니다.
...
HTML5로 개발되어 PC / 모바일 / 테블릿 등등 다양한 디바이스에서 동일한 사용자 경험을 제공하며  
카메라의 활용으로 아바타 / 코스튬등을 쉽게 제작하고 간단한 터치만으로 서로 콘텐츠를 공유/판매 할 수 있는 등 최적화된 사용자 인터페이스를 제공합니다.
