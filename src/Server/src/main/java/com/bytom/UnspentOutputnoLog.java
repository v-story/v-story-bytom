...
public class UnspentOutputnoLog {
    /**
    ...
    private static Logger logger = Logger.getLogger(UnspentOutputnoLog.class);
    ...
    public static class QueryBuilder {
         ...
         */
        public List<UnspentOutputnoLog> list(Client client) throws BytomException {

            Type listType = new ParameterizedTypeImpl(List.class, new Class[]{UnspentOutputnoLog.class});
            List<UnspentOutputnoLog> unspentOutputList = client.request("list-unspent-outputs", this, listType);
            logger.info("list-unspent-outputs:");
            logger.info("size of unspentOutputList:" + unspentOutputList.size());
            /*
            for (UnspentOutputnoLog UTXO : unspentOutputList) {
