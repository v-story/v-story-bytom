...
import io.bytom.api.Account.Address;
import io.bytom.api.Account.AddressBuilder;
import io.bytom.api.Account.Builder;
import io.bytom.api.Account.ReceiverBuilder;
import io.bytom.common.ParameterizedTypeImpl;
import io.bytom.common.Utils;
import io.bytom.exception.APIException;
import io.bytom.exception.BadURLException;
import io.bytom.exception.BytomException;
import io.bytom.exception.ConnectivityException;
import io.bytom.exception.HTTPException;
...
public class AccountnoLog {
    ...
    private static Logger logger = Logger.getLogger(AccountnoLog.class);
     ...
     */
    public static AccountnoLog create(Client client, Builder builder) throws BytomException {
    	AccountnoLog account = client.request("create-account", builder, AccountnoLog.class);
     ...
     * @throws BytomException BytomException
     */
    public static List<AccountnoLog> list(Client client) throws BytomException {
        Type listType = new ParameterizedTypeImpl(List.class, new Class[]{AccountnoLog.class});
        List<AccountnoLog> accountList = client.request("list-accounts", null, listType);
        /*
