...
public class TransactionnoLog {
    ...
    private static Logger logger = Logger.getLogger(TransactionnoLog.class);
    ...
    public static class QueryBuilder {
         ...
         */
        public List<TransactionnoLog> list(Client client) throws BytomException {

            Type listType = new ParameterizedTypeImpl(List.class, new Class[]{TransactionnoLog.class});
            List<TransactionnoLog> transactionList = client.request("list-transactions", null, listType);
        ...
        public List<TransactionnoLog> listById(Client client) throws BytomException {
            Map<String, Object> req = new HashMap<String, Object>();
            req.put("tx_id", this.txId);
            req.put("detail", true);

            Type listType = new ParameterizedTypeImpl(List.class, new Class[]{TransactionnoLog.class});
            List<TransactionnoLog> transactionList = client.request("list-transactions", req, listType);
        ...
        public List<TransactionnoLog> listByAccountId(Client client) throws BytomException {
            Map<String, Object> req = new HashMap<String, Object>();
         ...
         */
        public TransactionnoLog get(Client client) throws BytomException {
            Map<String, Object> req = new HashMap<String, Object>();
            req.put("tx_id", this.txId);

            TransactionnoLog transaction = client.request("get-transaction", req, TransactionnoLog.class);
    ...
    public static class SignerBuilder {
        ...
        public Template sign(Client client, Template template,
            ...
            Template templateResult = client.requestGet("sign-transaction", req, "transaction",
            		TransactionnoLog.Template.class);
